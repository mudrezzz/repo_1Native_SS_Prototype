...
/**
 * Specifies methods used to obtain and modify Advertiser related information
 * which is stored in the database.
 */
@Repository("FN_Service_db.AdvertiserDao")
public class AdvertiserDao extends WMGenericDaoImpl<Advertiser, Integer> {
