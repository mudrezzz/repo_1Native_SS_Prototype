...
/**
 * Specifies methods used to obtain and modify Ads related information
 * which is stored in the database.
 */
@Repository("FN_Service_db.AdsDao")
public class AdsDao extends WMGenericDaoImpl<Ads, Integer> {
