...
/**
 * Specifies methods used to obtain and modify StatsDays related information
 * which is stored in the database.
 */
@Repository("FN_Service_db.StatsDaysDao")
public class StatsDaysDao extends WMGenericDaoImpl<StatsDays, Integer> {
