...
/**
 * Specifies methods used to obtain and modify Publisher related information
 * which is stored in the database.
 */
@Repository("FN_Service_db.PublisherDao")
public class PublisherDao extends WMGenericDaoImpl<Publisher, Integer> {
