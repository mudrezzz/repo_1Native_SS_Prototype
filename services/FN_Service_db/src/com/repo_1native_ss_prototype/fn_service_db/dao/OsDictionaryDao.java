...
/**
 * Specifies methods used to obtain and modify OsDictionary related information
 * which is stored in the database.
 */
@Repository("FN_Service_db.OsDictionaryDao")
public class OsDictionaryDao extends WMGenericDaoImpl<OsDictionary, Integer> {
