...
/**
 * Specifies methods used to obtain and modify Tags related information
 * which is stored in the database.
 */
@Repository("FN_Service_db.TagsDao")
public class TagsDao extends WMGenericDaoImpl<Tags, Integer> {
