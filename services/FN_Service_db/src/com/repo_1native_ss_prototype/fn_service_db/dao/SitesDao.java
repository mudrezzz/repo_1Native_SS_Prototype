...
/**
 * Specifies methods used to obtain and modify Sites related information
 * which is stored in the database.
 */
@Repository("FN_Service_db.SitesDao")
public class SitesDao extends WMGenericDaoImpl<Sites, Integer> {
