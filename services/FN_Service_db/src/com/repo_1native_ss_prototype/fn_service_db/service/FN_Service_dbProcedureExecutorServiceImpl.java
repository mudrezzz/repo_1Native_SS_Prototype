...
@Service
public class FN_Service_dbProcedureExecutorServiceImpl implements FN_Service_dbProcedureExecutorService {

    private static final Logger LOGGER = LoggerFactory.getLogger(FN_Service_dbProcedureExecutorServiceImpl.class);

    @Autowired
    @Qualifier("FN_Service_dbWMProcedureExecutor")
